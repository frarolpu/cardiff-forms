"""
Update forms_final.json to add matrix structure for 2.5.3
"""
...
for form in forms:
    if form['section'] == '2.5.3':
        ...
        # Update tasks with all 15 tasks from document
        form['tasks'] = [
            ...
            {"step": "12", "description": "Operate panel circuit breakers/switches in turn to ensure correct operation."},
            {"step": "13", "description": "Isolate supplies in conjunction with CCC and implement a thorough check on security of terminations"},
            {"step": "14", "description": "Clean panel exterior with proprietary stainless steel cleaning agent."},
            {"step": "15", "description": "Final inspection and documentation review"}
        ]
        
        print("✅ Updated form 2.5.3:")
        print(f"   - is_matrix: true")
        print(f"   - EDPs: {len(form['edps'])} (EDP-01 to EDP-14)")
        print(f"   - Tasks: {len(form['tasks'])} tasks")
        print(f"   - Sample task 1: {form['tasks'][0]['description'][:50]}...")
        break
...
print("\n✅ forms_final.json updated successfully!")
